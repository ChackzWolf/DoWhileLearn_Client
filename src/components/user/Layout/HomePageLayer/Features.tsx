...
export function Features() {
    return (
        <div className="flex flex-col justify-between overflow-hidden">
            ...
            <div className="w-full flex flex-col md:flex-row justify-between items-center p-5 md:p-0">
                <motion.div
                    initial={{ opacity: 0, x: -100 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.5, delay: 0.15 }}
                    className="h-full text-accent flex items-center md:mx-20">
                    <div className="md:mx-20  flex flex-col justify-center h-full">
                ...
                <motion.div
                    ...
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.5, delay: 0.15 }}
                    className="flex items-center justify-center md:mx-20">
                    <Lottie
                        animationData={animationData}
                        loop={true}
                        className="h-[250px] w-full md:h-[400px] md:w-[500px]"
                        //style={{ height: '250px', width: '500px' }} // Adjust height and width here
                    />
                </motion.div>
            </div>
            ...
            <div className="w-full flex flex-col-reverse md:flex-row justify-between items-center p-5 md:p-0">
                <motion.div
                    initial={{ opacity: 0, x: -100 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.5, delay: 0.15 }}
                    className="flex items-center justify-center md:mx-20 pr-5">
                    <Lottie
            ...
            <div className="w-full flex flex-col-reverse md:flex-row justify-between items-center p-5">
                <motion.div
                    initial={{ opacity: 0, x: -100 }}
