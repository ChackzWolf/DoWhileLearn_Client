...
import { setEditCourse2, toNext, toPrev } from '../../../../redux/tutorSlice/CourseSlice/editCourseData'; // Adjust the path as needed
...
const EditCourse2 = () => {
    ...
    const CreateCourse2 = useSelector((state:RootState)=> state.editCourseData.editCourse2)
    ...
    return (
        <div className="flex items-center justify-center m-5 px-4 h-[600px]">
            <div className="w-full max-w-4xl  shadow-lg rounded-lg px-8 py-6 h-full">
                <h2 className="text-2xl font-semibold text-gray-800 mb-6">Edit Course Details</h2>
                ...
                <Formik
                    ...
                    onSubmit={(values) => {
                        ...
                        dispatch(setEditCourse2(values));
                        dispatch(toNext())
                    }}
                >
                    {({ values }) => (
